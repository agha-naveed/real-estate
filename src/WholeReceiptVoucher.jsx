...
export default function WholeReceiptVoucher() {
  ...
  return (
    <div className='w-full h-auto'>
      <div className="add-btn w-full p-5 flex justify-end">
        <Link to='new-receipt-voucher' className='flex bg-primary-clr w-fit py-[6px] px-[24px] text-white rounded-[22px] gap-[6px] items-center transition-all hover:bg-dark-primary-clr'>
